...
uint8_t acc_B5[6]      = {0 ,58,65,0 ,0 ,0 };
uint8_t acc_F5[6]      = {0 ,57,65,69,72,76};
uint8_t acc_C5[6]      = {0 ,60,64,0 ,0 ,0 };
uint8_t acc_G5[6]      = {55,59,0 ,0 ,0 ,0 };
uint8_t acc_D5[6]      = {0 ,0 ,62,69,0 ,0 };
uint8_t acc_A5[6]      = {0 ,57,64,0 ,0 ,0 };
uint8_t acc_E5[6]      = {52,59,0 ,0 ,0 ,0 };
